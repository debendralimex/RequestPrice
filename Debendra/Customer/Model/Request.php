...
class Request extends AbstractModel implements RequestInterface, IdentityInterface
{
    ...
    const CACHE_TAG = 'debendra_customer_request_price';

    /**
     * @var string
     */
    public $cacheTag = 'debendra_customer_request_price';

    /**
     * @var string
     */
    public $eventPrefix = 'debendra_customer_request_price';
    ...
    {
        $this->_init('Debendra\Customer\Model\ResourceModel\Request');
    }
